...
var creatorList = ['@DAVID','@DAVIDGNZ','@shopgame_david','@bot', '@dreambot','@david','@david', '@hlganz'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6287880120452 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6287880120452 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'Davidkey') return res.json(loghandler.invalidKey)
